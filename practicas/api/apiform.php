...
<body>
    <form action="./sendrequest.php" method="post">
        ...
        <div class="field">
            ...
            <div class="control">
            <input value="WS62666666._.9" name="user_inp" class="input" type="text" placeholder="********" />
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input value="Fiserv135." name="upass_inp" class="input" type="password" placeholder="********" />
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
            <input value="Fiserv135." name="cpass_inp" class="input" type="password" placeholder="********" />
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
            <input value="C:\Users\falbe\Documents\Fiserv\Certificados P12\Tiendas\WS62666666._.9.p12" name="cpath_inp" class="input" type="text" placeholder="********" />
            </div>
        </div>
        ...
        <div class="column">
            ...
            <div class="field">
                ...
                <div class="control">
                  <input value=4147463011110059 name="card_inp" class="input" type="number" placeholder="xxxx xxxx xxxx xxxx" />
                </div>
            </div>
